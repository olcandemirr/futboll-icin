    ...
    <div className="p-6 bg-[#F6F6F4FB] min-h-screen">
      ...
      <header className="mb-6">
        <h1 className="text-3xl font-bold text-center text-gray-800">
          Kulübünüzün yönetim paneline hoş geldiniz
        </h1>
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
        <button
          onClick={() => router.push("/sporcular")}
          className="bg-green-500 text-white p-6 rounded-lg flex flex-col items-center hover:bg-green-600 transition-all duration-200"
        >
          <FaUsers className="text-3xl mb-2" /> <span>Sporcular</span>
        </button>
        <button
          onClick={() => router.push("/antermanlar")}
          className="bg-blue-500 text-white p-6 rounded-lg flex flex-col items-center hover:bg-blue-600 transition-all duration-200"
        >
          <FaRunning className="text-3xl mb-2" /> <span>Antremanlar</span>
        </button>
        <button
          onClick={() => router.push("/aidatlar")}
          className="bg-red-500 text-white p-6 rounded-lg flex flex-col items-center hover:bg-red-600 transition-all duration-200"
        >
          <FaWallet className="text-3xl mb-2" /> <span>Aidatlar</span>
        </button>
        <button
          onClick={() => router.push("/genel-ayarlar")}
          className="bg-purple-500 text-white p-6 rounded-lg flex flex-col items-center hover:bg-purple-600 transition-all duration-200"
        >
